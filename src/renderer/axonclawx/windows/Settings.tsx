...
const Settings: React.FC<SettingsProps> = ({ language, onLogout }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('axonclaw:open-window', handler as EventListener);
    return () => window.removeEventListener('axonclaw:open-window', handler as EventListener);
  }, []);
              ...
              <div className={rowCls}>
                <div className="px-5 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <SmartLink href="https://x.com/axonclawx"
                      className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-white/[0.03] transition-colors group">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-slate-400 dark:text-white/20 truncate">x.com/axonclawx</p>
                      </div>
                      <span className="material-symbols-outlined text-[14px] text-slate-300 dark:text-white/15 group-hover:text-primary">open_in_new</span>
                    </SmartLink>
                    <SmartLink href="https://axonclawx.com"
                      className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-white/[0.03] transition-colors group">
                      <span className="text-[20px]">🌐</span>
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-bold text-slate-700 dark:text-white/70 group-hover:text-primary">AxonClawX</p>
                        <p className="text-[10px] text-slate-400 dark:text-white/20 truncate">axonclawx.com</p>
                      </div>
                      <span className="material-symbols-outlined text-[14px] text-slate-300 dark:text-white/15 group-hover:text-primary">open_in_new</span>
                    </SmartLink>
                  </div>
