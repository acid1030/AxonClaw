...
> 根据 AxonClawX 启动器/主菜单的 16 个功能入口，在 AxonClaw 中补齐缺失菜单并复刻功能。
...
3. **Phase 3**: 逐项复刻 AxonClawX 功能（前端 UI + 后端 API）

## 四、后端技术说明

- **AxonClawX 后端**: Go (internal/handlers, internal/gateway)
